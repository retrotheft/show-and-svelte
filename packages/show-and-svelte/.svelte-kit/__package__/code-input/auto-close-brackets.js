export function createAutoCloseBracketsPlugin(bracketPairs = { '(': ')', '[': ']', '{': '}', '"': '"' }) {
    return {
...
function checkBrackets(event, textarea, bracketPairs) {
    if (!event.data)
        return;
...
function checkBackspace(event, textarea, bracketPairs) {
